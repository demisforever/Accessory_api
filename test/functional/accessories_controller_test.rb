...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { name: @accessory.name, nationality: @accessory.nationality, price: @accessory.price }
    end
  ...
  test "should update accessory" do
    put :update, id: @accessory, accessory: { name: @accessory.name, nationality: @accessory.nationality, price: @accessory.price }
    assert_response 204
  end
